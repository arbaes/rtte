...
const BALL_COLORS: [Rgb; 3] = [
    Rgb { r: 0xd1, g: 0xf4, b: 0xa5 },
    Rgb { r: 0x96, g: 0xe2, b: 0xa4 },
    Rgb { r: 0x5a, g: 0xcd, b: 0xa9 },
];
...
impl BouncyBallsEffect {
    pub fn new(grid: &Grid) -> Self {
        ...
        let final_gradient = Gradient::new(
            &[Rgb::from_hex("f8ffae"), Rgb::from_hex("43c6ac")],
            12,
        );
        ...
        for ch in &self.chars {
            ...
            if ch.landed {
                if ch.final_y < self.height && ch.final_x < self.width {
                    ...
                    let t = if ch.done { 1.0 } else { ch.fade_frame as f64 / ch.fade_total as f64 };
